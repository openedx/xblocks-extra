...
class SchoolYourselfXBlock(XBlock):
    ...
    module_id = String(
        help=("The full ID of the module as it would appear on schoolyourself.org, such as 'geometry/lines_rays'."),
        scope=Scope.settings,
    ...
    module_title = String(
        help=("The human-readable title of the module, such as 'Lines and rays'."),
        scope=Scope.settings,
    ...
    base_url = String(
        help=(
            "The base URL that the iframes will be pointing to. Do not put "
    ...
    shared_key = String(
        help=(
            "This is the key that we use to verify signed data coming "
    ...
    partner_id = String(
        help=(
            "This is the string that is passed as the partner_id param "
        ...
        if user_id:
            ...
            if shared_key:
                url_params["partner_signature"] = hmac.new(
                    bytes(shared_key, "utf-8"), bytes(user_id, "utf-8"), digestmod=hashlib.md5
                ).hexdigest()
    ...
    def studio_view(self, context=None):
        ...
        fragment.add_javascript(self.resource_string("static/js/studio_view.js"))
    ...
    def studio_submit(self, data, suffix=""):
        ...
        self.module_description = data.get("module_description", "Welcome to School Yourself!")
        self.base_url = data.get("base_url", "https://schoolyourself.org")
