...
class SchoolYourselfLessonXBlock(SchoolYourselfXBlock):
    ...
    def student_view(self, context=None):
        ...
        screenshot_url = f"{self.base_url}/page/screenshot/{self.module_id}"

        context = {
            "iframe_url": f"{self.base_url}/page/embed?{six.moves.urllib.parse.urlencode(url_params)}",
        ...
        fragment = Fragment(self.render_template("lesson_student_view.html", context))
        ...
        fragment.add_javascript(self.resource_string("static/js/lesson_student_view.js"))
