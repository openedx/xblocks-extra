...
class SchoolYourselfReviewXBlock(SchoolYourselfXBlock):
    ...
    def student_view(self, context=None):
        ...
        mastery_url = f"{self.base_url}/progress/mastery?{six.moves.urllib.parse.urlencode(mastery_url_params)}"

        context = {
            "iframe_url": f"{self.base_url}/review/embed?{six.moves.urllib.parse.urlencode(iframe_url_params)}",
            "title": self.module_title,
            "icon_url": self.runtime.local_resource_url(self, "public/review_icon.png"),
        ...
        fragment = Fragment(self.render_template("review_student_view.html", context))

        # Load the common JS/CSS libraries:
        fragment.add_css_url(self.runtime.local_resource_url(self, "public/sylib.css"))
        fragment.add_javascript_url(self.runtime.local_resource_url(self, "public/sylib.js"))

        # And finally the embedded HTML/JS code:
        fragment.add_javascript(self.resource_string("static/js/review_student_view.js"))
        fragment.add_css(self.resource_string("static/css/student_view.css"))
    ...
    def handle_grade_json(self, data):
        ...
        self.runtime.publish(self, "grade", {"value": scaled_mastery_level, "max_value": 1.0})
