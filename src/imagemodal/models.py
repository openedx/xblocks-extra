...
class ImageModalModelMixin:
    ...
    image_url = String(
        ...
        scope=Scope.settings,
        help=_("This is the location of the full-screen image to be displayed."),
    )
    ...
    alt_text = String(
        ...
        default="",
        scope=Scope.settings,
        help=_("This field allows you to add alternate or descriptive text that pertains to your image."),
    )
